# Development Rules (Not for company's operation)

Technoledge Co. is a small company that operated by Agents. The development is based on pi framework.
...
3. The development plan is defined in [company-development-plan.md](./company-development-plan.md).
